      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10 mb-24">
        <div className="flex flex-col gap-10">
          {posts.map((post) => (
            ...
            >
              <article className="glass-card p-8 md:p-10 rounded-2xl flex flex-col md:flex-row gap-8 items-start group-hover:-translate-y-2 group-hover:border-[var(--accent)]/30 group-hover:shadow-[0_0_30px_rgba(124,58,237,0.1)] transition-all duration-300 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-[var(--accent)]/0 via-[var(--accent)]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                <div className="flex-1 relative z-10">
                  <div className="flex items-center flex-wrap gap-4 text-sm font-mono text-[var(--text-muted)] mb-4">
                    ...
                    <span className="text-[var(--border)] hidden sm:inline-block">
                      |
                    </span>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold font-display text-[var(--text-primary)] mb-4 group-hover:text-[var(--accent)] transition-colors leading-snug">
                    {post.title}
                  </h2>
                  ...
                  <div className="flex items-center gap-2 text-[var(--text-primary)] font-medium font-mono text-sm group/btn">
                    Read Post
                    <ArrowRight className="w-4 h-4 text-[var(--accent)] group-hover/btn:translate-x-2 transition-transform" />
                  </div>
                </div>
              </article>
            </Link>
