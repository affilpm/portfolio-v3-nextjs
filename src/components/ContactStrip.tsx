  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto rounded-3xl p-10 md:p-16 lg:p-20 text-center relative z-10 border border-[var(--card-border)] bg-[var(--card-bg)] backdrop-blur-xl shadow-2xl overflow-hidden group">
        ...
        <div className="absolute top-0 right-0 w-64 h-64 bg-[var(--accent)]/20 blur-[80px] rounded-full group-hover:scale-110 transition-transform duration-700" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-[var(--accent-2)]/20 blur-[80px] rounded-full group-hover:scale-110 transition-transform duration-700" />
        ...
        >
          <span className="text-sm font-bold tracking-widest text-[var(--accent)] uppercase mb-4">
            Contact
          </span>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold font-display text-[var(--text-primary)] mb-6 leading-normal py-2">
